...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/index.js
var modern_exports = {};
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/QueryClientProvider.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/HydrationBoundary.js
  ...
  createResult(query, options) {
    ...
    if (options.placeholderData !== void 0 && data === void 0 && status === "pending") {
      ...
      if (prevResult?.isPlaceholderData && options.placeholderData === prevResultOptions?.placeholderData) {
        ...
        skipSelect = true;
      } else placeholderData = typeof options.placeholderData === "function" ? options.placeholderData(__privateGet(this, _lastQueryWithDefinedData)?.state.data, __privateGet(this, _lastQueryWithDefinedData)) : options.placeholderData;
    ...
    if (options.select && data !== void 0 && !skipSelect) {
      if (prevResult && data === prevResultState?.data && options.select === __privateGet(this, _selectFn)) data = __privateGet(this, _selectResult);
      else try {
...
var MutationObserver = (_a9 = class extends Subscribable {
  ...
  setOptions(options) {
    ...
    else if (__privateGet(this, _currentMutation)?.state.status === "pending") __privateGet(this, _currentMutation).setOptions(this.options);
  }
  onSubscribe() {
  ...
  onUnsubscribe() {
    if (!this.hasListeners()) __privateGet(this, _currentMutation)?.removeObserver(this);
  }
  ...
  notifyManager.batch(() => {
    if (__privateGet(this, _mutateOptions) && this.hasListeners()) {
      ...
      if (action?.type === "success") {
        try {
          __privateGet(this, _mutateOptions).onSuccess?.(action.data, variables, onMutateResult, context);
        } catch (e) {
          Promise.reject(e);
        }
        try {
          __privateGet(this, _mutateOptions).onSettled?.(action.data, null, variables, onMutateResult, context);
        } catch (e) {
          Promise.reject(e);
        }
      } else if (action?.type === "error") {
        try {
          __privateGet(this, _mutateOptions).onError?.(action.error, variables, onMutateResult, context);
        } catch (e) {
          Promise.reject(e);
        }
        try {
          __privateGet(this, _mutateOptions).onSettled?.(void 0, action.error, variables, onMutateResult, context);
        } catch (e) {
          Promise.reject(e);
        }
      }
...
var QueriesObserver = (_a10 = class extends Subscribable {
  ...
  return !__privateGet(this, _options)?.combine || __privateGet(this, _observers2).some((observer, index) => {
  ...
  queries.forEach((options) => {
    ...
    const observer = prevObserversMap.get(defaultedOptions.queryHash)?.shift() ?? new QueryObserver(__privateGet(this, _client5), defaultedOptions);
    observers.push({
  ...
  if (this.hasListeners()) {
    ...
    const newResult = shouldSkipCombine ? previousResult : __privateMethod(this, _QueriesObserver_instances, combineResult_fn).call(this, __privateMethod(this, _QueriesObserver_instances, trackResult_fn).call(this, __privateGet(this, _result), __privateGet(this, _observerMatches)), __privateGet(this, _options)?.combine);
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/IsRestoringProvider.js
import * as React3 from "react";
var IsRestoringContext = React3.createContext(false);
var useIsRestoring = () => React3.useContext(IsRestoringContext);
var IsRestoringProvider = IsRestoringContext.Provider;

// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/QueryErrorResetBoundary.js
...
var QueryErrorResetBoundary = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx2(QueryErrorResetBoundaryContext.Provider, {
    value,
    children: typeof children === "function" ? children(value) : children
  });
};

// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/errorBoundaryUtils.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/suspense.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/useQueries.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/useBaseQuery.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/useQuery.js
function useQuery(options, queryClient) {
  return useBaseQuery(options, QueryObserver, queryClient);
}

// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/useSuspenseQuery.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/useSuspenseInfiniteQuery.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/useSuspenseQueries.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/usePrefetchQuery.js
function usePrefetchQuery(options, queryClient) {
  const client = useQueryClient(queryClient);
  if (!client.getQueryState(options.queryKey)) client.query(options).catch(noop);
}

// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/usePrefetchInfiniteQuery.js
function usePrefetchInfiniteQuery(options, queryClient) {
  const client = useQueryClient(queryClient);
  if (!client.getQueryState(options.queryKey)) client.infiniteQuery(options).catch(noop);
}

// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/queryOptions.js
function queryOptions(options) {
  return options;
}

// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/infiniteQueryOptions.js
function infiniteQueryOptions(options) {
  return options;
}

// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/useIsFetching.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/useMutationState.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/useMutation.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/mutationOptions.js
function mutationOptions(options) {
  return options;
}

// ../../node_modules/.pnpm/@tanstack+react-query@5.102.8_react@19.2.8/node_modules/@tanstack/react-query/build/modern/useInfiniteQuery.js
