...
// ../../node_modules/.pnpm/antd-img-crop@4.30.0_antd@6.6.1_react-dom@19.2.8_react@19.2.8__react@19.2.8__react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/antd-img-crop/dist/antd-img-crop.esm.js
var antd_img_crop_esm_exports = {};
__export(antd_img_crop_esm_exports, {
  default: () => ImgCrop
});
...
// ../../node_modules/.pnpm/react-easy-crop@5.5.7_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/react-easy-crop/index.module.mjs
...
var EasyCrop = forwardRef((props, ref) => {
  ...
  return jsxs(Fragment, { children: [jsx(Cropper, Object.assign({}, cropperProps, { ref: cropperRef, image: modalImage, crop, zoom, rotation, aspect, minZoom, maxZoom, zoomWithScroll: zoomSlider, cropShape, showGrid, onCropChange: setCrop, onZoomChange: setZoom, onRotationChange: setRotation, onCropComplete, classes: {
...
var ImgCrop = forwardRef((props, cropperRef) => {
  ...
  const getNewUpload = useCallback((children2) => {
...
// shell/.ojm-shim-antd-img-crop.mjs
var ojm_shim_antd_img_crop_default = ImgCrop ?? antd_img_crop_esm_exports;
export {
  ojm_shim_antd_img_crop_default as default
};
