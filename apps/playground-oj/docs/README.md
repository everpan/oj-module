...
| 文档 | 阶段 | 一句话 |
|---|---|---|
| [phase0-scaffold.md](./phase0-scaffold.md) | P0 骨架 | `ojm init` 骨架 + oj 登录冒烟 + `ojm dev` 反代联调 |
| [phase1-injection-and-contracts.md](./phase1-injection-and-contracts.md) | P1 注入与契约 | 运行时 D9 注册表 + `ojm api` 契约生成/豁免 + 11 模块自包含 |
...
| [phase5-release-and-integration.md](./phase5-release-and-integration.md) | P5 release 回归 | `ojm build` + 两态（dev/preview）集成冒烟 |
